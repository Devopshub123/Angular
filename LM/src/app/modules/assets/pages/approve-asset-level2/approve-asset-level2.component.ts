...
@Component({
  selector: 'app-approve-asset-level2',
  templateUrl: './approve-asset-level2.component.html',
  styleUrls: ['./approve-asset-level2.component.scss']
})
export class ApproveAssetLevel2Component implements OnInit {
  ...
  cancel(){     
    ...
    this.router.navigate(["/Asset/ApproveAsset"]));
  }
}