...
@Component({
  selector: 'app-emp-request-asset',
  templateUrl: './emp-request-asset.component.html',
  styleUrls: ['./emp-request-asset.component.scss']
})
export class EmpRequestAssetComponent implements OnInit {
  requestAssetForm!: FormGroup;
  displayedColumns = ['sno','cname','email','type','address','action'];
  ...
  constructor(private formBuilder: FormBuilder,private router: Router,private companyServices: CompanySettingService,) {
  }
