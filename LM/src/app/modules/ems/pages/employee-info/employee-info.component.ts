    ...
    this.personalInfoForm = this.formBuilder.group(
      {
        ...
        personalemail: ["", [Validators.email, Validators.pattern('^[a-zA-Z0-9.-]{1,}@[a-zA-Z.-]{2,}[.]{1}[a-zA-Z]{2,}')]],
        spokenLanguages: [""],
        checked: [false],
        paddress: ["",],
        pcountry: ["",],
        ...
        officeemail: ["", [Validators.email, Validators.pattern('^[a-zA-Z0-9.-]{1,}@[a-zA-Z.-]{2,}[.]{1}[a-zA-Z]{2,}')]],
        usertype: [[],],
        designation: ["",],
        department: ["",],
        employmentType: ["",],
