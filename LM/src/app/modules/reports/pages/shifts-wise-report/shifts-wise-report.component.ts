...
export class ShiftsWiseReportComponent implements OnInit {
  ...
  exportAsXLSX() {
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Shifts_Wise_Report');

    /* save to file */
    //XLSX.writeFile(wb, 'Monthly_Detail_Report_for_manager_'+this.monthdata+'_'+this.year+'.xlsx');
    XLSX.writeFile(wb, 'Shifts_Wise_Report_for_manager.xlsx');
  ...
  public exportPDF(): void {
    ...
    pdfMake.createPdf({
      ...
      pageSize:'A3'
      //'portrait'
    }).download("Shifts Wise Report.pdf");
