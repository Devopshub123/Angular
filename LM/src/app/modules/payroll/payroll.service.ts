...
@Injectable({
  ...
  export class PayrollService {
    ...
    getesidetails():Observable<any>{
        ...
        return this.http.get(this.mainBeUrl +'payroll/api/getesidetails/'+ this.companyName,this.httpOptions)
    }
    getemployerprofessionaltax():Observable<any>{
        return this.http.get(this.mainBeUrl +'payroll/api/employerprofessionaltax/'+ this.companyName,this.httpOptions)
    }
    getemployeeprofessionaltax():Observable<any>{
        return this.http.get(this.mainBeUrl +'payroll/api/employeeprofessionaltax/'+ this.companyName,this.httpOptions)
    }
    ...
    getearningsalarycomponent(data:any):Observable<any>{
      return this.http.post(this.mainBeUrl +'payroll/api/getearningsalarycomponent/'+ data+'/'+this.companyName,this.httpOptions)
    }
    getdeductionsalarycomponent(data:any):Observable<any>{
        return this.http.post(this.mainBeUrl +'payroll/api/getdeductionsalarycomponent/'+data+'/'+this.companyName,this.httpOptions)
    }
    ...
    getpayrollincomegroups():Observable<any>{
        return this.http.post(this.mainBeUrl +'payroll/api/getpayrollincomegroups/'+this.companyName,this.httpOptions)
    }
    ...
    getEmployeeDurationsForSalaryDisplay(userid:any): Observable<any> {
        return this.http.get(this.mainBeUrl + 'payroll/api/getEmployeeDurationsForSalaryDisplay/'+ userid+'/'+this.companyName,this.httpOptions);
    }
    getCtcDetails(eid:any,ctcid:any): Observable<any> {
        return this.http.get(this.mainBeUrl + 'payroll/api/getCtcDetails/'+ eid+'/'+ctcid+'/'+this.companyName,this.httpOptions);
    }
    getEmployeeInvestments(empid:any): Observable<any> {
        return this.http.get(this.mainBeUrl + 'payroll/api/getEmployeeInvestments/'+ empid+'/'+this.companyName,this.httpOptions);
    }
    ...
    getComponentEditableConfigurations(id:any): Observable<any> {
        return this.http.get(this.mainBeUrl + 'payroll/api/getComponentEditableConfigurations/'+ id+'/'+this.companyName,this.httpOptions);
    }
    ...
    getPayGroupComponentValues(id:any): Observable<any> {
        return this.http.get(this.mainBeUrl + 'payroll/api/getPayGroupComponentValues/'+ id+'/'+this.companyName,this.httpOptions);
    }
    getEmployeesListForInvestmentsApproval(): Observable<any> {
        return this.http.get(this.mainBeUrl + 'payroll/api/getEmployeesListForInvestmentsApproval/'+this.companyName,this.httpOptions);
    }
    // getEmployeeEpfContributionOptions
    getEmployeeEpfContributionOptions(): Observable<any> {
        return this.http.get(this.mainBeUrl + 'payroll/api/getEmployeeEpfContributionOptions/'+this.companyName,this.httpOptions);
    }
    // getEmployerEpfContributionOptions
    getEmployerEpfContributionOptions(): Observable<any> {
        return this.http.get(this.mainBeUrl + 'payroll/api/getEmployerEpfContributionOptions/'+this.companyName,this.httpOptions);
    }
    //setCompanyEpfValues
    ...
    getStatutoryMaxPfWageForEmployerContribution(): Observable<any> {
        return this.http.get(this.mainBeUrl + 'payroll/api/getStatutoryMaxPfWageForEmployerContribution/'+this.companyName,this.httpOptions);
    }
    // updateEpfWages
    ...
    getFileMasterForEMS(input:any){
      ...
      getCompanyPaySchedule(): Observable<any> {
        return this.http.get(this.mainBeUrl + 'payroll/api/getCompanyPaySchedule/'+this.companyName,this.httpOptions);
      }
      ...
      getFinancialYears(): Observable<any> {
        return this.http.get(this.mainBeUrl + 'payroll/api/getFinancialYears/'+this.companyName,this.httpOptions);
      }
      Month_Year(Month_Year:any): Observable<any> {
        return this.http.get(this.mainBeUrl + 'payroll/api/MonthYear/'+Month_Year+'/'+this.companyName,this.httpOptions);
      }
      getEpfDetails():Observable<any> {
        return this.http.get(this.mainBeUrl + 'payroll/api/getEpfDetails/'+this.companyName,this.httpOptions);
      }
      getEmployeeListForSalaryProcessing(Month:any,year:any): Observable<any> {
        return this.http.get(this.mainBeUrl + 'payroll/api/getEmployeeListForSalaryProcessing/'+Month+'/'+year+'/'+this.companyName,this.httpOptions);
      }
      getEmployeesForAssignPaygroup():Observable<any> {
        return this.http.get(this.mainBeUrl + 'payroll/api/getEmployeesForAssignPaygroup/'+this.companyName,this.httpOptions);
      }
      getPayGroupsForCtc(Amount:any): Observable<any> {
        return this.http.get(this.mainBeUrl + 'payroll/api/getPayGroupsForCtc/'+Amount+'/'+this.companyName,this.httpOptions);
      }
      getActiveComponentsValuesForPayGroup(id:any): Observable<any> {
        return this.http.get(this.mainBeUrl + 'payroll/api/getActiveComponentsValuesForPayGroup/'+id+'/'+this.companyName,this.httpOptions);
      }
      ...
      getEmployeePaySlips(data:any): Observable<any> {
        return this.http.get(this.mainBeUrl+'payroll/api/getEmployeePaySlips/'+data.fyear+'/'+data.id+'/'+this.companyName,this.httpOptions);
      }
      getEmployeePayslipDetails(data:any): Observable<any> {
        return this.http.get(this.mainBeUrl+'payroll/api/getEmployeePayslipDetails/'+data.id+'/'+data.empid+'/'+this.companyName,this.httpOptions);
      }
      getEmployeeEpfDetails(data:any): Observable<any> {
        return this.http.get(this.mainBeUrl+'payroll/api/getEmployeeEpfDetails/'+data+'/'+this.companyName,this.httpOptions);
      }
      getMonthlyPayrollData(data:any): Observable<any> {
        return this.http.get(this.mainBeUrl+'payroll/api/getMonthlyPayrollData/'+data.month+'/'+data.year+'/'+data.deptid+'/'+this.companyName,this.httpOptions);
      }
      getMonthlyPayrollDataForGraph(data:any): Observable<any> {
        return this.http.get(this.mainBeUrl+'payroll/api/getMonthlyPayrollDataForGraph/'+data.month+'/'+data.year+'/'+this.companyName,this.httpOptions);
      }
      getComponentConfiguredValuesForPayGroup(data:any): Observable<any> {
        return this.http.get(this.mainBeUrl+'payroll/api/getComponentConfiguredValuesForPayGroup/'+data.pgmid+'/'+data.flat+'/'+this.companyName,this.httpOptions);
      }
}