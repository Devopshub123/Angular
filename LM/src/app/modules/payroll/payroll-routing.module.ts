...
const routes: Routes = [
  {    path: '', component: MainComponent,
    children: [
      ...
      { path: 'Earnings', component: EarningsComponent,canActivate:[LMSAccessGuard]},  
      { path: 'EarningsRequest', component: EarningsRequestComponent,canActivate:[LMSAccessGuard]}, 
